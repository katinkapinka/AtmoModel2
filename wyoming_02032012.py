...
# version 02032012 - station number integrated - test of outfile, if download was successful
#                  - first final version
'''
...
try:
    ...
    print("You need to specify a station on the command line") # e.g.: Meiningen: 10548, Essen: 10410
    station = raw_input("station:")

outfile="sounding_"+year+"_"+month+"_"+day+"_"+time+"_"+station+".dat"

os.system("curl -s 'http://weather.uwyo.edu/cgi-bin/sounding?region=europe&TYPE=TEXT%3ALIST&YEAR="+year+"&MONTH="+month+"&FROM="+day+""+time+"&TO="+day+""+time+"&STNM="+station+"' > "+outfile)


'''Test for data in outfile'''
